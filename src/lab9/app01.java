...
public class App01 implements ActionListener {
    ...
    public App01() {
        ...
        // Add Listener (ลงทะเบียนปุ่มเพื่อให้กดแล้วมีผล)
        btn1.addActionListener(this);
        btn2.addActionListener(this);
        btn3.addActionListener(this);
        btn4.addActionListener(this);

        // Set Layout p1 (แบ่งเป็น 4 แถว 1 คอลัมน์)
        p1.setLayout(new GridLayout(4, 1));
        p1.add(txt1);
        p1.add(txt2);
        p1.add(p2); // เอาแผงปุ่ม p2 ยัดใส่ลงใน p1
        p1.add(txt3);

        // Set Layout p2 (เรียงปุ่มเป็นแนวนอน)
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource().equals(btn1)) {
            System.out.println("btn1"); // แสดงผลเมื่อกดปุ่มบวก
